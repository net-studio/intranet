    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={styles.profileHeader}>
          ...
          >
            {updating ? (
              ...
              <Image source={{ uri: GlobalApi.API_URL + user?.image }} style={styles.avatar} />
            ) : (
        ...
        <View style={styles.section}>
          ...
          {renderProfileField('Nom d\'utilisateur', user?.prenom + " " + user?.nom)}
          {renderProfileField('Email', user?.email, 'email')}
          {renderProfileField('Téléphone', user?.telephone, 'phone')}
