...
const notificationService = {
  ...
  registerForPushNotifications: async () => {
    try {
      ...
      try {
        ...
        // const PROJECT_ID = 'votre-id-de-projet'; // À remplacer par votre ID réel si vous en avez un
  ...
  getNotifications: async (page = 1, pageSize = 20, unreadOnly = false) => {
    try {
      ...
      let queryParams = `filters[user][id]=${userId}&pagination[page]=${page}&pagination[pageSize]=${pageSize}&sort=createdAt:desc`;
